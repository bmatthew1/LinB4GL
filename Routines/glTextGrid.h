...
public:
    glTextGrid (char *texFile, FileOpener *files, int rows, int cols, int texRows, int texCols);
    ~glTextGrid ();
...
class glTextGridWindow : public glWindow {
    glTextGrid  *m_textGrid;
...
public:
    ...
    glTextGrid *TextGrid ()                 { return m_textGrid; }
    void SetTextGrid (glTextGrid *value)    { m_textGrid = value; }
